...
void setup() {
  ...
  imu::initMag();
  //TODO : init other sensors here - accel and gyro

  mahonyInit(ahrs);
  // TODO: run gyro bias capture here and set gyroCal.bias
  // TODO: load saved magCal from EEPROM/flash if you have it
}
